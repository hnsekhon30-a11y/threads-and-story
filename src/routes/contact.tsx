...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Haseena By Hasneet" },
      {
        name: "description",
        content:
          "Get in touch with Haseena By Hasneet — find our studio, ask about a piece, or join the newsletter for early access to new collections.",
      },
      { property: "og:title", content: "Contact — Haseena By Hasneet" },
      {
        ...
        <div>
          ...
          <dl className="mt-10 space-y-6 text-sm">
            ...
            <div>
              ...
              <dd className="mt-1 text-foreground/80">
                <a href="mailto:hello@haseenaabyhasneet.example" className="hover:text-primary">
                  hello@haseenaabyhasneet.example
                </a>
              </dd>
            </div>
            <div>
