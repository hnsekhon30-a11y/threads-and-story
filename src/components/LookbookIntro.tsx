...
export function LookbookIntro() {
  ...
  return (
    <section className="relative flex h-screen w-full flex-col justify-center overflow-hidden bg-background">
      <div
        className="relative"
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-10 mx-auto flex max-w-7xl items-end justify-between px-6">
